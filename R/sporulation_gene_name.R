...
#'
#' @param df A data frame of gene annotations for a single MAG. Must include at least columns:
#'   \code{Preferred_name} and \code{KEGG_ko}.
#'
#' @return A data frame of sporulation-associated genes with consensus gene names and classification step.
#'
#' @export
#' @importFrom dplyr filter grepl rbind mutate select distinct
